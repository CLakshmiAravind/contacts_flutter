  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('My Contacts',style: TextStyle(fontSize: 25),),
      ),
      body: Center(child: Text('$list1'),),
      floatingActionButton: FloatingActionButton(
        onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (_)=>NewContacts()));setState(() {
          _fetchData();
        });},
        child: Icon(Icons.person_add_alt),
        backgroundColor: Colors.blueGrey,
        shape: ContinuousRectangleBorder(borderRadius: BorderRadius.circular(12),side: BorderSide(width: 2.0 )),
      ),
    );
  }
}